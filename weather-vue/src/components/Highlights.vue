...
import { getPressureMm, getTime } from '../utils/utils.js';
...
const timezoneInfo = computed(() => props.weatherInfo?.timezone);

const sunriseTime = computed(() => {
	return getTime(props.weatherInfo.sys.sunrise + timezoneInfo.value);
});
const sunsetTime = computed(() => {
	return getTime(props.weatherInfo.sys.sunset + timezoneInfo.value);
});
</script>
